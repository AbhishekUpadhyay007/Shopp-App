...
class _AuthCardState extends State<AuthCard>
  ...
  void showErrorDialoge(String errorMessage) {
    showDialog(
        context: context,
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (error.toString().contains("WEAK_PASSWORD")) {
        errorMsg = "Provided password is too weak";
      }

      showErrorDialoge(errorMsg);
    } catch (error) {
      showErrorDialoge(error.message);
    }
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                ...
                AnimatedContainer(
                  duration: Duration(milliseconds: 300),
                  constraints: BoxConstraints(minHeight: _authMode == AuthMode.Signup ? 50 : 0, maxHeight: _authMode == AuthMode.Signup ? 100 : 0),
